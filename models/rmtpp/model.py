...
from .modules.rnn import ReluRNN
...
class RMTPP(nn.Module):
    def __init__(self, config) -> None:
        ...
        self.dtime_w = nn.Parameter(torch.rand(1)*0.1)
    ...
    def predict(self, type_seq, time_seq):
        ...
        density = torch.exp(time_enc + self.dtime_w * dt_vals +\
         (torch.exp(time_enc)-torch.exp(time_enc + self.dtime_w * dt_vals))\
